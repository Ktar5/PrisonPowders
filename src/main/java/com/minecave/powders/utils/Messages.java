package com.minecave.powders.utils;
...
public class Messages {
    ...
    public static void loadMessages(){
        for(String key : Powders.getInstance().getMessages().getConfig().getKeys(true)) {
            /*if(Powders.getInstance().getMessages().getConfig().get){

            }*/
            messages.put(key, StringUtil.colorString(Powders.getInstance().getMessages().getConfig().getString(key)));
        }
    ...
    public static String get(String key){
        if(!messages.containsKey(key)) {
            ...
            Powders.getInstance().getMessages().set(key, s, true);
            return s;
        }
